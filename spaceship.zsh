...
# GIT
SPACESHIP_GIT_SYMBOL="${SPACESHIP_GIT_SYMBOL=""}" # disable git prefix
SPACESHIP_GIT_PREFIX="${SPACESHIP_GIT_PREFIX="git:("}"
SPACESHIP_GIT_SUFFIX="${SPACESHIP_GIT_SUFFIX=") "}"

# GIT BRANCH
SPACESHIP_GIT_BRANCH_PREFIX="${SPACESHIP_GIT_BRANCH_PREFIX=""}" # disable branch prefix too
SPACESHIP_GIT_BRANCH_SUFFIX="${SPACESHIP_GIT_BRANCH_SUFFIX=""}" # remove space after branch name
...
# NODE
SPACESHIP_NODE_PREFIX="${SPACESHIP_NODE_PREFIX=""}"

# XCODE
SPACESHIP_XCODE_PREFIX="${SPACESHIP_XCODE_PREFIX=""}"

# SWIFT
SPACESHIP_SWIFT_PREFIX="${SPACESHIP_SWIFT_PREFIX=""}"

# GOLANG
SPACESHIP_GOLANG_PREFIX="${SPACESHIP_GOLANG_PREFIX=""}"

# PHP
SPACESHIP_PHP_PREFIX="${SPACESHIP_PHP_PREFIX=""}"

# RUST
SPACESHIP_RUST_PREFIX="${SPACESHIP_RUST_PREFIX=""}"

# JULIA
SPACESHIP_JULIA_PREFIX="${SPACESHIP_JULIA_PREFIX=""}"

# DOCKER
SPACESHIP_DOCKER_PREFIX="${SPACESHIP_DOCKER_PREFIX=""}"

# VENV
SPACESHIP_VENV_PREFIX="${SPACESHIP_VENV_PREFIX=""}"

# PYENV
SPACESHIP_PYENV_PREFIX="${SPACESHIP_PYENV_PREFIX=""}"
